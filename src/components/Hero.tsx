        ...
        <div className="mx-auto max-w-7xl lg:px-8">
          ...
          <div className="rounded-lg bg-gray-200 p-4">
            <Image
              ...
              src="https://source.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjF8fHBlb3BsZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60"
              alt=""
            />
          </div>
        </div>
